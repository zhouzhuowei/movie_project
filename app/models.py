...
app = Flask(__name__)
# app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:whm@192.168.48.132:3306/movie"
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:whm@47.100.17.209:3306/movie"
...
class User(db.Model):
    ...
    moviecols = db.relationship('Moviecol', backref='user')   # 电影收藏外键
...
if __name__ == "__main__":
    ...
    # admin = Admin(
    #     name = 'emaxy',
    #     pwd = generate_password_hash("emaxy"),
    #     is_super = 0,
    #     role_id = 1
    # )
